    ...
    return Expanded(
      child: FutureBuilder(
        future: newsProvider.sportsNews.isEmpty
            ? newsProvider.getAndFetchNews('sports').catchError((error) => showCustomDialogue(context, error))
            : Future.value(true),
                ...
                : Consumer<NewsProvider>(
                    builder: (context, newsItem, child) => Container(
                      ...
                      child: RefreshIndicator(
                        onRefresh: () => newsProvider.getAndFetchNews('sports').catchError((error) => showCustomDialogue(context, error)),
                        displacement: 2,
